...
function PredictionNode({ data }: PredictionNodeProps) {
  ...
  return (
    <div className="outline-1 outline rounded-md shadow-sm group-hover:shadow-md bg-white outline-neutral-200 p-2 border-2 border-stone-400 max-w-md">
      <NodeToolbar
      ...
      <div className="col-span-3 flex gap-4 mb-1 justify-between">
        ...
        />
        {data.isResolved ? 
          <ResolveButton question={data.question} /> :
