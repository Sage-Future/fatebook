...
export default function ListPage() {
  ...
  const parts =
    router.query.list_invite_id &&
    (router.query.list_invite_id as string).match(/(.*)--(.*)/)
  const listInviteId = parts
    ? parts[2]
    : (router.query.list_invite_id as string) || ""
    ...
    <div className="px-4 pt-12 lg:pt-16 mx-auto max-w-6xl">
      ...
      <div className="mx-auto">
        <div className="prose mx-auto lg:w-[650px]">
          ...
          {joinViaLink.isLoading && (
            <h3 className="text-neutral-600">Joining team...</h3>
          )}
          {joinViaLink.error && (
