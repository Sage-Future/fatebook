...
export default function ForSlackPage() {
  ...
  return (
    <div className="bg-neutral-50 grow">
      <NextSeo
        title="Fatebook for Slack"
        titleTemplate="Fatebook for Slack"
          ...
          <div className="flex mb-20">
            <div className="m-auto">
              <AddToSlack
                buttonText={
                  installedTo
                    ? "Add to another Slack workspace"
                    : "Add to Slack"
                }
              />
            </div>
              ...
              <figure className="max-w-screen-md mx-auto">
                ...
                <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  ...
                  <div className="flex items-center">
                    <div className="pr-2 font-medium text-neutral-900 ">
                      Niel Bowerman
                    </div>
        ...
        <Faqs
          faqs={[
            ...
            },
            {
              ...
              answer: "You can use /forecast in any channel.",
            },
            {
...
ForSlackPage.getLayout = function getLayout(page: React.ReactElement) {
  return (
    <Layout showForSlackButton={false} showCreateAccountButton={false}>
      {page}
    </Layout>
  )
}
