  ...
  return (
    <div className="px-4 pt-12 lg:pt-16 mx-auto max-w-6xl">
      <div className="prose mx-auto">
        <p>
          {isUnsubscribed ? 'You have unsubscribed from Fatebook emails. Click below to resubscribe.' : 'Unsubscribe below to stop receiving emails from Fatebook.'}
        </p>
        <div className='flex flex-col gap-4'>
          ...
          <button
            onClick={(e) => {
              e.preventDefault()
              if (!email) return
              unsubscribe.mutate({ userEmail: email, setUnsubscribed: !isUnsubscribed })
        ...
        {unsubscribe.isSuccess &&
          <>
            <h3 className="text-neutral-600">{isUnsubscribed ? 'You have been unsubscribed from all emails.' : 'You have been resubscribed to all emails.'}</h3>
