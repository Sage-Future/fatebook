  ...
  return (
    <div className="text-right">
      <Menu as="div" className="inline-block text-left relative w-full">
        <div className='w-full'>
          <Menu.Button
            className={clsx(
              ...
              resolution === "YES" ? "bg-green-500 text-white" : resolution === "NO" ? "bg-red-500 text-white" : resolution === "AMBIGUOUS" ? "bg-blue-500 text-white" : "bg-gray-200 text-grey-500"
            )}
        ...
        >
          <Menu.Items className="absolute z-50 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
