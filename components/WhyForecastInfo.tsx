      ...
      <ul className="list-none space-y-4 pl-0">
        <li className="flex items-center space-x-3">
          ...
          <span>
            ...
            <br />
            Get a clearer view of the consequences by thinking about the
            important questions.
          </span>
        </li>
        <li className="flex items-center space-x-3">
          ...
          <span>
            <span className="font-semibold">{"Communicate more clearly"}</span>
            <br />
            {
        ...
        <li className="flex items-center space-x-3">
          ...
          <span>
            <span className="font-semibold">{"Build your track record"}</span>
            <br />
            Resolve your predictions as YES, NO or AMBIGUOUS. A feedback loop to
