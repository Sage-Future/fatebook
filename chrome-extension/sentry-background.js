...
var Sentry = (function (exports) {
  ...
  function normalize(input, depth) {
    try {
      return JSON.parse(
        JSON.stringify(input, (key, value) => walk(key, value, depth)),
      )
    } catch (_oO) {
  ...
  function instrumentFetch() {
    ...
    fill(global$2, "fetch", function (originalFetch) {
      return function (...args) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
        return originalFetch.apply(global$2, args).then(
          (response) => {
            triggerHandlers(
              "fetch",
              Object.assign(Object.assign({}, handlerData), {
    ...
    update(captureContext) {
      ...
      if (captureContext instanceof Scope) {
        ...
        this._extra = Object.assign(
          Object.assign({}, this._extra),
          captureContext._extra,
        )
        this._contexts = Object.assign(
          Object.assign({}, this._contexts),
  ...
  class Hub {
    ...
    captureException(exception, hint) {
      ...
      this._invokeClient(
        "captureException",
        exception,
        Object.assign(Object.assign({}, finalHint), { event_id: eventId }),
      )
      return eventId
    }
    /**
    ...
    captureEvent(event, hint) {
      ...
      this._invokeClient(
        "captureEvent",
        event,
        Object.assign(Object.assign({}, hint), { event_id: eventId }),
      )
      return eventId
    }
    /**
  ...
  class BaseClient {
    ...
    _updateSessionFromEvent(session, event) {
      ...
      session.update(
        Object.assign(
          Object.assign({}, crashed && { status: SessionStatus.Crashed }),
          {
            user,
            userAgent,
  ...
  ***************************************************************************** */
  ...
  function eventToSentryRequest(event, api) {
    ...
    const _a = event.debug_meta || {},
      { transactionSampling } = _a,
    ...
    const req = {
      body: JSON.stringify(
        sdkInfo ? enhanceEventWithSdkInfo(event, api.metadata.sdk) : event,
      ),
      type: eventType,
      url: useEnvelope
  ...
  function popFrames(stacktrace, popSize) {
    try {
      return Object.assign(Object.assign({}, stacktrace), {
  ...
  class BaseTransport {
    ...
    _handleResponse({ requestType, response, headers, resolve, reject }) {
      ...
      if (limited)
        logger.warn(
          `Too many requests, backing off until: ${this._disabledUntil(
            requestType,
          )}`,
        )
  ...
  function getNativeFetchImplementation() {
    ...
    if (
      typeof ((_a = document) === null || _a === void 0
        ? void 0
        : _a.createElement) === `function`
    ) {
      try {
        ...
        if (
          (_b = sandbox.contentWindow) === null || _b === void 0
            ? void 0
            : _b.fetch
        ) {
  ...
  class BrowserBackend extends BaseBackend {
    ...
    _setupTransport() {
      ...
      const transportOptions = Object.assign(
        Object.assign({}, this._options.transportOptions),
      ...
      try {
        ...
        withScope((scope) => {
          scope.addEventProcessor((event) => {
            ...
            processedEvent.extra = Object.assign(
              Object.assign({}, processedEvent.extra),
              { arguments: args },
            )
            return processedEvent
          })
  ...
  class TryCatch {
    ...
    setupOnce() {
      ...
      if (this._options.eventTarget) {
        const eventTarget = Array.isArray(this._options.eventTarget)
        ...
        if (getCurrentHub().getIntegration(UserAgent)) {
          ...
          const url =
            ((_a = event.request) === null || _a === void 0
              ? void 0
              : _a.url) ||
            ((_b = global$3.location) === null || _b === void 0
              ? void 0
              : _b.href)
          ...
          const request = Object.assign(Object.assign({}, url && { url }), {
            headers,
          })
  ...
  function startSessionTracking() {
    ...
    if (
      typeof hub.startSession !== "function" ||
      typeof hub.captureSession !== "function"
    ) {
      return
    }
    hub.startSession()
  ...
  const INTEGRATIONS = Object.assign(
    Object.assign(Object.assign({}, windowIntegrations), CoreIntegrations),
    BrowserIntegrations,
  )
